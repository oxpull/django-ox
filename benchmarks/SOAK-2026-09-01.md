...
harness check is in `soak-results-raw-2026-09-01-SMOKE.json` and is not
part of the results.

This run repeats the [2026-08-16 run](SOAK-2026-08-16.md) on the current
release. That one measured 0.1.0; this one measures the lease renewal and
fencing that shipped in 0.2.0.
...
Three producer processes and three worker processes per load scenario, each producer targeting 10 tasks per second, 30 combined, across a mixed workload of quick,
...
This is the documented behaviour. django-ox executes
