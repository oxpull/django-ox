...
<small>The four drain cells (2,000 and 20,000 tasks) ran interleaved in a single measurement window. During kill trials 2 and 3 only, the test machine's desktop screensaver rendered an animated wallpaper, consuming 60-70% CPU; kill counts were unaffected.</small>
