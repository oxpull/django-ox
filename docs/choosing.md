...
[^tdb-worker]: https://github.com/RealOrangeOne/django-tasks-db/blob/main/django_tasks_db/management/commands/db_worker.py, `add_arguments`, checked 2026-08-23.
[^tdb-backend]: https://github.com/RealOrangeOne/django-tasks-db/blob/main/django_tasks_db/backend.py, `supports_priority = True`, checked 2026-08-23.
